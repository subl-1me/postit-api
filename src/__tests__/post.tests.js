...
describe('post routes tests', () => {
    ...
    beforeAll(async() => {
        ...
        .then(async(response) => {
            ...
            mock_user._id = userId; // rewrite _id to use it later
    ...
    it('POST api/post - Creates a new post', async () => {
        ...
        .post('/api/post/' + mock_user._id) //TODO: Change sending mock_user_id through param to body way
        .send(mock_post)
